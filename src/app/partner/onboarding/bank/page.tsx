        ...
        <div className='min-h-screen bg-white flex items-center justify-center px-4'>
            ...
            >
                <div className='relative text-center'>
                    <button className='absolute left-0 top-0 w-9 h-9 rounded-full border border-gray-300 flex text-black items-center justify-center hover:bg-gray-100 transition'
                        onClick={() => router.back()}
                ...
                <div className='mt-8 space-y-6'>
                    <div >
                        <label htmlFor="ahn" className='text-xs font-semibold  text-black'>Account holder name</label>
                        <div className='flex items-center gap-2 mt-2'>
                            ...
                            className={`flex-1 border-b pb-2  text-gray-800 text-sm focus:outline-none 
                    ...
                    <div >
                        <label htmlFor="ahn" className='text-xs font-semibold  text-black'>Bank account number</label>
                        <div className='flex items-center gap-2 mt-2'>
                            <div className='text-gray-400'><CreditCard /></div>
                            <input type="text" id='ahn' placeholder='Enter account number'  className={`flex-1 border-b text-gray-800 pb-2 text-sm focus:outline-none 
                    ...
                    <div >
                        <label htmlFor="ahn" className='text-xs font-semibold  text-black'>IFSC code</label>
                        <div className='flex items-center gap-2 mt-2'>
                            <div className='text-gray-400'><Landmark /></div>
                            <input type="text" id='ahn' placeholder='HDFC0001234'  className={`flex-1  text-gray-800 border-b pb-2 text-sm focus:outline-none 
                    ...
                    <div >
                        <label htmlFor="ahn" className='text-xs font-semibold text-black'>Mobile number</label>
                        <div className='flex items-center gap-2 mt-2'>
                            <div className='text-gray-400'><Phone /></div>
                            <input type="text" id='ahn' placeholder='10 digit mobile number'  className={`flex-1 text-gray-800 border-b pb-2 text-sm focus:outline-none 
                    ...
                    <div >
                        <label htmlFor="ahn" className='text-xs font-semibold text-black'>UPI ID (optional)</label>
                        <div className='flex items-center gap-2 mt-2'>
                            <input type="text" id='ahn' placeholder='name@upi' className='text-gray-800 flex-1 border-b pb-2 text-sm focus:outline-none border-gray-300 focus:border-black' value={upi} onChange={(e)=>setupi(e.target.value)}/>
                        </div>
                    </div>
                </div>
