        ...
        <div className='min-h-screen bg-white flex items-center justify-center px-4'>
            ...
            >
                <div className='relative text-center'>
                    <button className=' absolute left-0 top-0 w-9 h-9 rounded-full border border-gray-300 flex items-center text-black  justify-center hover:bg-gray-100 transition'
                        onClick={() => router.back()}
                ...
                <div className='mt-8 space-y-6'>
                    ...
                    <div>
                        ...
                        value={vehicleNumber}
                         ...
                         id='vn' 
                         className='mt-2 w-full border-b border-gray-300 pb-2 text-gray-700  text-sm focus:outline-none focus:border-black transition'/>
                    </div>
                    <div>
                        ...
                        value={vehicleModel}
                         ...
                         id='vm' 
                         className='mt-2 w-full border-b border-gray-300 text-gray-700 pb-2 text-sm focus:outline-none focus:border-black transition '/>
                    </div>
                </div>
