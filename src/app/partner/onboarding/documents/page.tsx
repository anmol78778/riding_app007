    ...
    <div className='min-h-screen bg-white flex items-center justify-center px-4'>
      ...
      >
        <div className='relative text-center'>
          <button className='absolute left-0 top-0 text-black w-9 h-9 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition'
            onClick={() => router.back()}
      ...
      className="flex items-center justify-between p-4 rounded-2xl border border-gray-200 cursor-pointer hover:border-black transition"
          >
            <div>
<p className='text-sm font-semibold text-black'>Aadhaar / ID Proof</p>
<p className='text-xs text-gray-500'>Government issued ID</p>
    ...
    <div>
      ...
      className="flex items-center justify-between p-4 rounded-2xl border border-gray-200 cursor-pointer hover:border-black transition"
          >
            <div>
<p className='text-sm font-semibold text-black'>Driving License</p>
